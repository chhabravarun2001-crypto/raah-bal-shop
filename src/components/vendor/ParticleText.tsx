...
const ParticleText = ({
  ...
  return (
    <div ref={containerRef} className={`relative block h-full w-full min-h-[240px] overflow-hidden [touch-action:none] [isolation:isolate] ${className}`} style={style} aria-label={text}>
      <canvas ref={canvasRef} className="absolute inset-0 block h-full w-full" aria-hidden="true" />
      <span className="absolute h-px w-px overflow-hidden whitespace-nowrap p-0 [clip:rect(0,0,0,0)]" style={{ margin: "-1px" }}>
        {text}
      </span>
    </div>
  );
